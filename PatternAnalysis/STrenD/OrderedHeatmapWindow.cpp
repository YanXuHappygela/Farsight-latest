...
OrderedHeatmap::OrderedHeatmap(QWidget *parent)
: QMainWindow(parent)
{
...
void OrderedHeatmap::setDataForHeatmap(double** features, int* optimalleaforder1, int* optimalleaforder2,int num_samples, int num_features)
{
...
void OrderedHeatmap::setDataForSimilarMatrixHeatmap(double** features, int* optimalleaforder1, int* optimalleaforder2,int num_samples, int num_features)
{
...
void OrderedHeatmap::creatDataForHeatmap(double powCof)
{
	this->scaleData();
...
void OrderedHeatmap::creatDataForTrendHeatmap(double powCof)
{
	std::vector< double > temp;
	temp.resize(num_features);
...
void OrderedHeatmap::creatDataForSimilarMatrixHeatmap(double *diagonal)
{
...
void OrderedHeatmap::setModels(vtkSmartPointer<vtkTable> table, ObjectSelection * sels, ObjectSelection * sels2)
{
	this->table = table;
...
void OrderedHeatmap::runClusclus()
{
	double** datas;
	vtkVariant temp; 
...
void OrderedHeatmap::SetInteractStyle()
{
...
void OrderedHeatmap::showSimilarMatrixGraph()
{	
    this->aPlane->SetXResolution(this->num_features);
    this->aPlane->SetYResolution(this->num_samples);
...
void OrderedHeatmap::showSPDGraph()
{	
	drawPoints3();
    this->aPlane->SetXResolution(this->num_features);
    this->aPlane->SetYResolution(this->num_samples);
...
void OrderedHeatmap::setDataForDendrograms(double** treedata1, double** treedata2)
{
	if(treedata1 != NULL)
	{
...
void OrderedHeatmap::createDataForDendogram1(double powCof)
{
...
void OrderedHeatmap::createDataForDendogram2(double powCof)
{
...
void OrderedHeatmap::showDendrogram1()
{
	double p1[3];
	double p2[3];
	double p3[3];
...
void OrderedHeatmap::showDendrogram2()
{
	double p1[3];
	double p2[3];
	double p3[3];
...
void OrderedHeatmap::GetSelecectedIDs()
{
...
void OrderedHeatmap::drawPoints1()
{
...
void OrderedHeatmap::drawPoints2()
{
...
void OrderedHeatmap::drawPoints3()
{
...
void OrderedHeatmap::SelectionCallbackFunction(vtkObject* caller, long unsigned int eventId, void* clientData, void* callData )
{
	...
	OrderedHeatmap* heatmapWin = (OrderedHeatmap*)clientData;
...
void OrderedHeatmap::SelectionCallbackFunction1(vtkObject* caller, long unsigned int eventId, void* clientData, void* callData )
{
	vtkAnnotationLink* annotationLink = static_cast<vtkAnnotationLink*>(caller);
	vtkSelection* selection = annotationLink->GetCurrentSelection();
	OrderedHeatmap* heatmapWin = (OrderedHeatmap*)clientData;
...
void OrderedHeatmap::SelectionCallbackFunction2(vtkObject* caller, long unsigned int eventId, void* clientData, void* callData )
{
	OrderedHeatmap* heatmapWin = (OrderedHeatmap*)clientData;
...
void OrderedHeatmap::SelectionCallbackFunction3(vtkObject* caller, long unsigned int eventId, void* clientData, void* callData )
{
	OrderedHeatmap* heatmapWin = (OrderedHeatmap*)clientData;
	int* pos = heatmapWin->view->GetInteractor()->GetEventPosition();
...
void OrderedHeatmap::HandleKeyPress(vtkObject* caller, long unsigned int eventId, void* clientData, void* callData )
{
	OrderedHeatmap* heatmapWin = (OrderedHeatmap*)clientData;
...
void OrderedHeatmap::SetdenSelectedIds1(std::set<long int>& IDs, bool bfirst)
{
...
void OrderedHeatmap::reselectIds1(std::set<long int>& selectedIDs, long int id)
{
...
void OrderedHeatmap::reselectIds2(std::set<long int>& selectedIDs2, long int id)
{
...
void OrderedHeatmap::computeselectedcells()
{
...
void OrderedHeatmap::setselectedCellIds()
{
	std::set<long int> selectedIDs1;
	std::set<long int> selectedIDs2;
...
void OrderedHeatmap::GetSelRowCol(int &r1, int &c1, int &r2, int &c2)
{
	r1 = this->r1;
	r2 = this->r2;
	c1 = this->c1;
...
void OrderedHeatmap::SetSelRowCol(int r1, int c1, int r2, int c2)
{
	this->r1 = r1;
	this->r2 = r2;
	this->c1 = c1;
...
void OrderedHeatmap::closeEvent(QCloseEvent *event)
{
