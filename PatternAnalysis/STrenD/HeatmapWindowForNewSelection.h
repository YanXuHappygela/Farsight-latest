#ifndef HEATMAPWINDOWFORNEWSELECTION_H
#define HEATMAPWINDOWFORNEWSELECTION_H
...
class HeatmapForNewSelection : public QMainWindow
{
    Q_OBJECT;

public:
	HeatmapForNewSelection(QWidget * parent = 0);
	~HeatmapForNewSelection();
...
protected slots:
	...
	void GetSelecectedIDsForSPD(std::set<long int> &selectedFeatureIDs, std::set<long int> &selectedIDs);
