...
STrenDAnalysisModel::STrenDAnalysisModel()
{
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GetDataTable()
{
...
QString STrenDAnalysisModel::GetFileName()
{
	return this->filename;
}

bool STrenDAnalysisModel::ReadCellTraceFile(std::string fileName, bool bContrast)
{
...
bool STrenDAnalysisModel::ReadRawData(std::string fileName)
{
	vtkSmartPointer<vtkTable> table = ftk::LoadTable(fileName);
	if( table != NULL)
	{
...
bool STrenDAnalysisModel::MergeMatrix( vnl_matrix<double> &firstMat, vnl_matrix<double> &secondMat, vnl_matrix<double> &combinedMat)
{
...
void STrenDAnalysisModel::ParseTraceFile(vtkSmartPointer<vtkTable> table, bool bContrast)
{
...
void STrenDAnalysisModel::ConvertTableToMatrix(vtkSmartPointer<vtkTable> table, vnl_matrix<double> &mat, std::vector<int> &index, vnl_vector<double> &distance)
{
...
void STrenDAnalysisModel::ConvertTableToMatrixForValidation(vtkSmartPointer<vtkTable> table, vnl_matrix<double> &mat, 
...
void STrenDAnalysisModel::ConvertMatrixToTable(vtkSmartPointer<vtkTable> table, vnl_matrix<double> &mat, vnl_vector<double> &distance)
{
...
int STrenDAnalysisModel::LineNum(const char* fileName)
{
	std::ifstream file(fileName, std::ifstream::in);
...
unsigned int STrenDAnalysisModel::GetSampleNum()
{
	return this->DataMatrix.rows();
}

unsigned int STrenDAnalysisModel::GetFeatureNum()
{
	return this->DataMatrix.cols();
}

unsigned int STrenDAnalysisModel::GetContrastDataSampleNum()
{
	return this->ContrastDataMatrix.rows();
}

void STrenDAnalysisModel::split(std::string& s, char delim, std::vector< std::string >* ret)
{
	size_t last = 0;
...
void STrenDAnalysisModel::NormalizeData( vnl_matrix<double> &mat)
{
...
void STrenDAnalysisModel::ClusterSamples(double cor)
{
...
void STrenDAnalysisModel::GetCombinedDataTable(vtkSmartPointer<vtkTable> table)
{
...
void STrenDAnalysisModel::CopyTable( vtkSmartPointer<vtkTable> oriTable, vtkSmartPointer<vtkTable> targetTable)
{
...
bool STrenDAnalysisModel::MergeTables(vtkSmartPointer<vtkTable> firstTable, vtkSmartPointer<vtkTable> secondTable, vtkSmartPointer<vtkTable> table)
{
...
void STrenDAnalysisModel::GetClusterIndexFromVnlVector(std::vector< std::vector<int> > &clusterIndex, vnl_vector<unsigned int> &index)
{
...
void STrenDAnalysisModel::GetAverageModule( vnl_matrix<double> &mat, vnl_vector<double> &distance, std::vector< std::vector<int> > &index, 
...
int STrenDAnalysisModel::ClusterSamples( double cor, vnl_matrix<double> &mat, vnl_vector<unsigned int> &index)									
{
...
void STrenDAnalysisModel::GetCellClusterSize( std::vector<int> &clusterSize)
{
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GetDataTableAfterCellCluster()
{
...
int STrenDAnalysisModel::ClusterAgglomerate(double cor, double mer)
{
...
void STrenDAnalysisModel::GetCombinedMatrix( vnl_matrix<double> &datamat, vnl_vector<unsigned int>& index, unsigned int moduleId, unsigned int moduleDeleteId, 
...
vnl_vector<int> STrenDAnalysisModel::GetModuleSize(vnl_vector<unsigned int>& index)   // index starts from 0
{
...
int STrenDAnalysisModel::GetSingleModuleSize(vnl_vector<unsigned int>& index, unsigned int ind)
{
	int size = 0;
	for( unsigned int i = 0; i < index.size(); i++)
	{
...
void STrenDAnalysisModel::GetMatrixRowMeanStd(vnl_matrix<double>& mat, vnl_vector<double>& mean, vnl_vector<double>& std)
{
	mbl_stats_nd stats;
...
void STrenDAnalysisModel::StandardizeIndex(vnl_vector<unsigned int>& index, vnl_vector<unsigned int> &indexmap)
{
	for(unsigned int i = 0; i < index.size(); i++)
	{
		unsigned int k = index[i];
...
void STrenDAnalysisModel::EraseZeroCol(vnl_matrix<double>& mat)
{
	int colNum = 0;
...
void STrenDAnalysisModel::EraseCols(vnl_matrix<double>& mat, std::vector<unsigned int> vec)
{
...
void STrenDAnalysisModel::ClusterMerge(double cor, double mer)
{
...
void STrenDAnalysisModel::GetFeatureIdbyModId(std::vector<unsigned int> &modID, std::vector<unsigned int> &featureID)
{
	for( int i = 0; i < ClusterIndex.size(); i++)
	{
...
void STrenDAnalysisModel::GetSubFeatureMatrix(vnl_matrix<double> &mat, std::vector< unsigned int> &featureId, vnl_matrix<double> &subMat, vnl_vector<double> &mean)
{
...
void STrenDAnalysisModel::GetSubSampleMatrix(vnl_matrix<double> &mat, std::vector< int> &sampleId, vnl_matrix<double> &subMat, vnl_vector<double> &mean)
{
...
void STrenDAnalysisModel::ConvertClusIndexToSampleIndex(std::vector< std::vector< long int> > &clusIndex, std::vector< std::vector< long int> > &sampleIndex)
{
...
void STrenDAnalysisModel::GetArrangedMatrixByConnectedComponent(std::vector< std::vector< long int> > &index, vnl_matrix<double> &mat)
{
...
void STrenDAnalysisModel::GetClusterMapping( std::map< int, int> &index)
{
	index = combinedIndexMapping;
}

void STrenDAnalysisModel::GetSingleLinkageClusterMapping(std::vector< std::vector< long int> > &index, std::vector<int> &newIndex)
{
...
void STrenDAnalysisModel::HierachicalClustering()    
{
...
double STrenDAnalysisModel::VnlVecMultiply(vnl_vector<double> const &vec1, vnl_vector<double> const &vec2)
{
...
void STrenDAnalysisModel::SubstitudeVectorElement( vnl_vector<unsigned int>& vector, unsigned int ori, unsigned int newValue)
{
...
void STrenDAnalysisModel::DeleteMatrixColumn( vnl_matrix<double>& mat, unsigned int col)
{
...
bool STrenDAnalysisModel::SetProgressionType(bool bProg)
{
	if( disCor != 0)
	{
...
bool STrenDAnalysisModel::GetProgressionType()
{
	return this->bProgression;
}

void STrenDAnalysisModel::GenerateMST()
{
...
bool STrenDAnalysisModel::IsConnected(std::multimap<int, int> &neighborGraph, std::vector<long int> &index1, std::vector<long int> &index2)
{
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GenerateMST( vnl_matrix<double> &mat, std::vector< unsigned int> &selFeatures, std::vector<int> &clusterNum)
{
...
void STrenDAnalysisModel::WriteGraphToGDF( std::vector< unsigned int> &selFeatures)
{
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GenerateSubGraph( vnl_matrix<double> &mat, std::vector< std::vector< long int> > &clusIndex, std::vector< unsigned int> &selFeatures, std::vector<int> &clusterNum)
{
	std::vector<int> nstartRow;
	nstartRow.resize(clusterNum.size());
	for( int i = 0; i < clusterNum.size(); i++)
...
double STrenDAnalysisModel::ComputeModuleDistanceAndConnection(vnl_matrix<double> &mati, vnl_matrix<double> &matj, int &rowi, int &rowj)
{
...
void STrenDAnalysisModel::GetAverageVec(vnl_matrix<double> &mat, vnl_vector<double> &vec)
{
...
double STrenDAnalysisModel::EuclideanBlockDist( vnl_vector<double>& vec1, vnl_vector<double>& vec2)
{
...
void STrenDAnalysisModel::GetCombinedMatrix( vnl_matrix<double> &datamat, int nstart, int nrow, std::vector< unsigned int> selFeatureIDs, vnl_matrix<double>& mat)
{
	int count = 0;
...
void STrenDAnalysisModel::GetCombinedMatrixByModuleId( vnl_matrix<double> &datamat, std::vector< std::vector< unsigned int> > &featureClusterIndex, std::vector< unsigned int> &selModuleIDs, vnl_matrix<double>& mat)
{
...
void STrenDAnalysisModel::GenerateDistanceMST()
{
	if(disCor <= 10)
	{
		return;
...
double STrenDAnalysisModel::CityBlockDist( vnl_matrix<double>& mat, unsigned int ind1, unsigned int ind2)
{
...
void STrenDAnalysisModel::CityBlockDist( vnl_matrix<double>& mat, vnl_matrix<double>& matDis)
{
...
void STrenDAnalysisModel::EuclideanBlockDist( vnl_matrix<double>& mat, vnl_matrix<double>& matDis)
{
	unsigned int nrows = mat.rows();
	matDis.set_size( nrows, nrows);
	matDis.fill(1e6);
...
void STrenDAnalysisModel::EuclideanBlockDist( vnl_vector<double>& vec, vnl_matrix<double>& matDis)
{
...
double STrenDAnalysisModel::EuclideanBlockDist( vnl_matrix<double>& mat, unsigned int ind1, unsigned int ind2)
{
	vnl_vector<double> module1 = mat.get_row(ind1);
	vnl_vector<double> module2 = mat.get_row(ind2);
	vnl_vector<double> subm = module1 - module2;
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GetMSTTable( int MSTIndex)
{
...
void STrenDAnalysisModel::GetTableHeaders(std::vector<std::string> &headers)
{
	headers = this->headers;
}

void STrenDAnalysisModel::GetMatrixDistance( vnl_matrix<double>& data, vnl_vector<double>&distance, DISTANCE_TYPE type)
{
...
void STrenDAnalysisModel::GetMSTMatrixDistance( vnl_vector<double>& distance, std::vector< boost::graph_traits<Graph>::vertex_descriptor>& vertex, vnl_vector<double>& MSTdistance)
{
...
void STrenDAnalysisModel::Hist(vnl_vector<double>&distance, int num_bin, vnl_vector<double>& interval, vnl_vector<unsigned int>& histDis)
{
...
void STrenDAnalysisModel::Hist(vnl_vector<double>&distance, vnl_vector<double>& interval, vnl_vector<unsigned int>& histDis)
{
...
void STrenDAnalysisModel::Hist(vnl_vector<double>&distance, double interVal, double minVal, vnl_vector<unsigned int>& histDis, int num_bin = NUM_BIN)
{
	histDis.set_size( num_bin);
	histDis.fill(0);
...
void STrenDAnalysisModel::Hist(vnl_matrix<double>&distance, double interVal, double minVal, vnl_vector<unsigned int>& histDis, int num_bin = NUM_BIN)
{
	histDis.set_size( num_bin);
	histDis.fill(0);
...
double STrenDAnalysisModel::EarthMoverDistance(vnl_vector<unsigned int>& first, vnl_vector<unsigned int>& second,
...
void STrenDAnalysisModel::RunEMDAnalysis(int numBin)
{
	...
	//	}
	//}
	std::cout<< "NS matrix has been built successfully"<<endl;
}

void STrenDAnalysisModel::GetEMDMatrixDivByMax(vnl_matrix<double> &emdMatrix)
{
	emdMatrix =  this->EMDMatrix;
}

//void STrenDAnalysisModel::GetClusClusData(clusclus *c1, clusclus *c2, double threshold, std::vector< unsigned int> *disModIndex)
//{
...
void STrenDAnalysisModel::GetClusClusDataMST(clusclus *c1, double threshold, std::vector< unsigned int> *disModIndex)
{
	QString filenameSM = this->filename + "similarity_matrix.txt";
	std::ofstream ofSimatrix(filenameSM .toStdString().c_str(), std::ofstream::out);
	ofSimatrix.precision(4);
...
void STrenDAnalysisModel::GetBiClusData(vnl_matrix<double> &mat, clusclus *c1, vnl_vector<double> *diagVec)
{
...
void STrenDAnalysisModel::GetSelectedFeaturesModulesTest(double selThreshold, std::vector<std::vector<unsigned int> > &selModules)
{
	selModules.clear();
...
int STrenDAnalysisModel::GetSelectedFeaturesModulesByConnectedComponent(double selThreshold, std::vector<std::vector<unsigned int> > &selModules)
{
	Graph graph;
	for( unsigned int i = 0; i < this->EMDMatrix.rows(); i++)
	{
...
int STrenDAnalysisModel::GetSelectedFeaturesModulesForBlockVisualization(vnl_matrix<double> &mat, double selThreshold, std::vector< std::vector<unsigned int> > &tmpSelModules)
{
	tmpSelModules.clear();
	std::set< unsigned int> processedModules;
	std::vector< unsigned int> tmpModules;
...
double STrenDAnalysisModel::GetConnectionAccuracy( vtkSmartPointer<vtkTable> treeTable, vnl_matrix<double> &disMat, vnl_vector<double> &accuracyVec,
...
void STrenDAnalysisModel::GetValidationVec(vnl_vector<int> &validationVec)
{
	validationVec = clusNo;
}

void STrenDAnalysisModel::GetClusClusDataKNNG(clusclus *c1,vnl_vector<double> *diagVec, std::vector< unsigned int> *disModIndex)
{
	//QString filenameSM = this->filename + "similarity_matrix.txt";
	//std::ofstream ofSimatrix(filenameSM .toStdString().c_str(), std::ofstream::out);
	//ofSimatrix.precision(4);
...
bool STrenDAnalysisModel::DiagnalIteration(vnl_matrix<double> &mat, vnl_vector<int> &order, vnl_vector<double> &vec)
{
	unsigned int nrows = mat.rows();
	vec.set_size(nrows);
	for( unsigned int i = 0; i < nrows; i++)
...
void STrenDAnalysisModel::GetClusClusNSWithoutIterData(clusclus* c1, double threshold)
{
	QString filenameSM = this->filename + "similarity_matrix.txt";
	std::ofstream ofSimatrix(filenameSM .toStdString().c_str(), std::ofstream::out);
	ofSimatrix.precision(4);
...
void STrenDAnalysisModel::GetClusClusNSData(clusclus* c1)
{
	if(c1)
	{
		c1->Initialize( this->EMDMatrix.data_array(), this->EMDMatrix.rows(), this->EMDMatrix.cols());
...
void STrenDAnalysisModel::GetCombinedMatrix( vnl_matrix<double> &datamat, vnl_vector< unsigned int> & index, std::vector< unsigned int> moduleID, vnl_matrix<double>& mat)
{
	unsigned int i = 0;
	unsigned int ind = 0;
...
bool STrenDAnalysisModel::IsExist(std::vector<unsigned int> vec, unsigned int value)
{
...
long int STrenDAnalysisModel::GetSelectedFeatures( vnl_vector< unsigned int> & index, std::vector<unsigned int> moduleID, std::set<long int>& featureSelectedIDs)
{
	long int count = 0;
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GenerateProgressionTree( std::string& selectedModules)
{
...
void STrenDAnalysisModel::GetSelectedFeatures(std::set<long int>& selectedFeatures)
{
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GetNormalizedTableAfterFeatureSelection(std::vector<unsigned int>& selectedFeatures)
{
	vtkSmartPointer<vtkTable> table = vtkSmartPointer<vtkTable>::New();
...
int STrenDAnalysisModel::tableToDoubleArray(vtkSmartPointer<vtkTable> table, double *arr, int N, int D)
{
	if( table->GetNumberOfColumns() != D + 1)
	{
		return -1;
	}
	for( int i = 0; i < N; i++)
	{
		vtkSmartPointer<vtkVariantArray> rowArr = table->GetRow(i);
		for( int j = 0; j < D; j++)
		{
			arr[ i * D + j] = rowArr->GetValue(j + 1).ToDouble();
		}
	}
	return 0;
}
...
void STrenDAnalysisModel::doubleArrayToTable(vtkSmartPointer<vtkTable> table, double *arr, int N, int D)
{
	...
	{	
		...
		column->SetName( str.c_str());
		for( int j = 0; j < N; j++)
		{
			column->InsertNextValue( arr[j * D + i]);
		}
		table->AddColumn(column);
	}
}

double STrenDAnalysisModel::GetEMDSelectedPercentage(double thres)
{
	unsigned int count = 0;
	double per = 0;
...
double STrenDAnalysisModel::GetEMDSelectedThreshold( double per)
{
	return 0;
}

void STrenDAnalysisModel::GetMatrixData(vnl_matrix<double> &mat)
{
	mat = DataMatrix.normalize_columns();
}

void STrenDAnalysisModel::GetDistanceOrder(std::vector<long int> &order)
{
	order.clear();
...
void STrenDAnalysisModel::GetClusterMatrixData(vnl_matrix<double> &mat)
{
	mat = UNMatrixAfterCellCluster;
}

void STrenDAnalysisModel::GetClusterOrder(std::vector< std::vector< long int> > &clusIndex, std::vector<long int> &treeOrder, std::vector< int> &clusterOrder)
{
	clusterOrder.clear();
	if( clusIndex.size() > 0)
	{
	...
	else
	{
		for( int i = 0; i < treeOrder.size(); i++)
		{
			clusterOrder.push_back(treeOrder[i]);
		}
	}
}

void STrenDAnalysisModel::GetValidationOrder(std::vector< int> &clusterOrder)
{
...
/// for spdtestwindow
void STrenDAnalysisModel::ModuleCoherenceMatchAnalysis()
{
...
unsigned int STrenDAnalysisModel::GetKNeighborNum()
{
	return m_kNeighbor;
}
...
void STrenDAnalysisModel::ModuleCorrelationMatrixMatch2(unsigned int kNeighbor, int nbins)
{
...
void STrenDAnalysisModel::GetWeightsFromSorting(vnl_matrix< double> &modDist, vnl_vector<int>& index, vnl_vector<double>& weights, unsigned int kNeighbor)
{
...
void STrenDAnalysisModel::ModuleCorrelationMatrixMatch(unsigned int kNeighbor, int nbins)
{
	m_kNeighbor = kNeighbor;
	std::cout<< m_kNeighbor<<std::endl;
...
double STrenDAnalysisModel::GetAutoSimilarityThreshold(unsigned int level)
{
	...
	unsigned int bin_num = level;
	if( size[0] * size[1] < level)
	{
		bin_num = 20;
	}
...
bool STrenDAnalysisModel::SearchSubsetsOfFeatures(std::vector< unsigned int> &selModules)   // feature id 
{
	if( disCor > 0)
	{
...
void STrenDAnalysisModel::FindNearestKSample(vnl_matrix< double> &modDist, std::vector< unsigned int>& index, unsigned int kNeighbor)
{
...
void STrenDAnalysisModel::FindFarthestKSample(vnl_matrix< double> &modDist, std::vector< unsigned int>& index, unsigned int kNeighbor)
{
	index.resize( modDist.rows() * kNeighbor);
	for( int i = 0; i < modDist.rows(); i++)
	{
...
void STrenDAnalysisModel::GetKWeights(vnl_matrix< double> &modDist, std::vector< unsigned int>& index, 
...
void STrenDAnalysisModel::GetKWeightsComplement(vnl_matrix< double> &modDist, std::vector< unsigned int>& index, 
...
int STrenDAnalysisModel::GetConnectedComponent(std::vector< unsigned int> &selFeatureID, std::vector<int> &component)
{
...
void STrenDAnalysisModel::WriteKNNGConnectionMatrix(const char *filename, std::vector< unsigned int> selFeatureID)
{
	vnl_matrix<double> selMat;
	GetCombinedMatrix( this->MatrixAfterCellCluster, 0, this->MatrixAfterCellCluster.rows(), selFeatureID, selMat);
	/*vnl_matrix< double> distMat;
...
void STrenDAnalysisModel::BuildMSTForConnectedComponent(std::vector< unsigned int> &selFeatureID, std::vector<int> &component, int connectedNum)
{
	vnl_matrix<double> selMat;
	GetCombinedMatrix( this->MatrixAfterCellCluster, 0, this->MatrixAfterCellCluster.rows(), selFeatureID, selMat);
	vnl_matrix< double> distMat;
...
void STrenDAnalysisModel::GetComponentMinDistance( vnl_matrix<double> &distMat, std::vector<int> &component, int connectedNum, vnl_matrix<double> &dis)
{
...
void STrenDAnalysisModel::GetComponentMinDistance(std::vector< unsigned int> selFeatureID, std::vector<int> &component, int connectedNum, vnl_matrix<double> &dis)
{
	vnl_matrix<double> selMat;
	GetCombinedMatrix( this->MatrixAfterCellCluster, 0, this->MatrixAfterCellCluster.rows(), selFeatureID, selMat);
	vnl_matrix< double> distMat;
...
double STrenDAnalysisModel::FindMinBetweenConnectComponent(vnl_matrix<double> &dis, std::vector<int> ver1, std::vector<int> ver2)
{
	double min = 1e9;
...
int STrenDAnalysisModel::GetConnectedComponent(std::vector< unsigned int>& index, std::vector< int>& component, unsigned int kNeighbor)
{
	Graph graph;
	for( int i = 0; i < index.size(); i++)
	{
...
void STrenDAnalysisModel::GetCombinedInversedMatrix(vnl_matrix<double> &datamat, vnl_vector<unsigned int>& index, unsigned int moduleId, unsigned int moduleInversedId, vnl_matrix<double>& mat)
{
	unsigned int i = 0;
	unsigned int ind = 0;
...
void STrenDAnalysisModel::GetClusClusDataForCorMatrix( clusclus* c1, clusclus* c2, double threshold, std::vector< unsigned int> *disModIndex)
{
...
double STrenDAnalysisModel::GetCorMatSelectedPercentage(double thres)
{
	unsigned int count = 0;
	double per = 0;
	if( false == bProgression)
...
void STrenDAnalysisModel::SetMaxVertexID(int verId)
{
	maxVertexId = verId;
}

void STrenDAnalysisModel::GetPercentage(std::vector< std::vector< long int> > &clusIndex, std::vector< double> &colorVec)
{
	colorVec.clear();
	for( int i = 0; i < clusIndex.size(); i++)
	{
...
void STrenDAnalysisModel::GetCloseToDevicePercentage( std::vector< std::vector< long int> > &clusIndex, std::vector< double> &disPer, double disThreshold)
{
	disPer.clear();
...
void STrenDAnalysisModel::ConvertVertexToClusIndex(std::set<long int> &vertextIds, std::set<int> &clusIndex)
{
	clusIndex.clear();
	for( std::set<long int>::iterator iter = vertextIds.begin(); iter != vertextIds.end(); iter++)
	{
		int ind = indMapFromVertexToClus.find(int(*iter))->second;
		clusIndex.insert(ind);
	}
}

void STrenDAnalysisModel::GetClusterFeatureValue(std::vector< std::vector< long int> > &clusIndex, int nfeature, vnl_vector<double> &featureValue, std::string &featureName)
{
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GetAverModuleTable(std::vector< std::vector< long int> > &clusIndex, std::vector<long int> &TreeOrder, std::vector< int> &selFeatureOrder, std::vector< int> &unselFeatureOrder)
{
	vtkSmartPointer<vtkTable> table = vtkSmartPointer<vtkTable>::New();
...
vtkSmartPointer<vtkTable> STrenDAnalysisModel::GetTableForHist(std::vector< int> &selFeatureOrder, std::vector< int> &unselFeatureOrder)
{
	vtkSmartPointer<vtkTable> table = vtkSmartPointer<vtkTable>::New();
...
bool STrenDAnalysisModel::RunSPDforFeatureDistributionTable(std::string fileName)
{
	std::ifstream file(fileName.c_str(), std::ifstream::in);
	int line = LineNum(fileName.c_str());
	if( !file.is_open() || line == -1)
...
void STrenDAnalysisModel::ComputeDistributionDistance(vnl_matrix<unsigned int> &mat, vnl_matrix<double> &dismat)
{
...
void STrenDAnalysisModel::ComputeDistributionDistance(vnl_matrix<unsigned int> &mat, vnl_vector<double> &moduleDistance)
{
	int rows = mat.rows();
...
bool STrenDAnalysisModel::GenerateMST( vnl_matrix<double> &mat, bool bfirst)
{
...
void STrenDAnalysisModel::RunEMDAnalysis( vnl_vector<double> &moduleDistance, int ind)
{
...
double STrenDAnalysisModel::CaculatePS(unsigned int kNeighbor, unsigned int nbins, vnl_vector<double> &vec1, vnl_vector<double> &vec2, bool debug)
{
...
void STrenDAnalysisModel::ModuleCorrelationNS(unsigned int kNeighbor, int nbins)
{
	m_kNeighbor = kNeighbor;
...
void STrenDAnalysisModel::EMDMatrixIteration(vnl_matrix<double> &afterIterMat)
{
...
bool STrenDAnalysisModel::NSIterationRadius2(vnl_matrix< double> &input, vnl_matrix< double> &output)
{
	bool bchanged = false;
...
double STrenDAnalysisModel::CaculateNS(unsigned int kNeighbor, unsigned int nbins, vnl_vector<double> &vec1, vnl_vector<double> &vec2, bool debug)
{
	if( abs(vec1.max_value() - vec1.min_value()) < 1e-6 ||  abs(vec2.max_value() - vec2.min_value()) < 1e-6)
	{
		return 0;
...
double STrenDAnalysisModel::CaculateNSomplementUsingShortestPath(unsigned int kNeighbor, unsigned int nbins, vnl_vector<double> &vec1, vnl_vector<double> &vec2, double ratio, bool debug)
{
	if( abs(vec1.max_value() - vec1.min_value()) < 1e-6 ||  abs(vec2.max_value() - vec2.min_value()) < 1e-6)
	{
		return 0;
...
bool STrenDAnalysisModel::GetKDistanceMetricRatio(vnl_vector<double> &vec1, vnl_vector<double> &vec2, vnl_matrix<double> &shortestPath, unsigned int kNeighbor)
{	
...
double STrenDAnalysisModel::CaculatePSAveragebin(unsigned int kNeighbor, unsigned int nbins, vnl_vector<double> &vec1, vnl_vector<double> &vec2, bool debug)
{
	vnl_matrix< double> contextDis;
...
double STrenDAnalysisModel::gaussrand(double exp, double std)
{
...
void STrenDAnalysisModel::AvarageBinHistogram(vnl_matrix<double> &disMetric, int nbins, vnl_vector<double> &binInterval)
{
...
void STrenDAnalysisModel::AverageHist(vnl_vector<double>&distance, vnl_vector<double>& binInterval, vnl_vector<unsigned int>& histDis)
{
...
void STrenDAnalysisModel::quickSort(double *arr, int left, int right, int *id) 
{
      int i = left;
	  int j = right;
      double tmp = 0;
...
double STrenDAnalysisModel::SimulateVec2(unsigned int kNeighbor, unsigned int nbins, vnl_vector<double> &vec1, vnl_vector<double> &vec2, bool debug)
{
