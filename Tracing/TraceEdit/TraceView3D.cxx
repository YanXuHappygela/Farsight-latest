...
void View3D::CreateGUIObjects()
{
	...
	//this->SPDAction = new QAction("STrenD Analysis", this->CentralWidget);
	//connect (this->SPDAction, SIGNAL(triggered()), this, SLOT(STrenDAnalysis()));

	this->STrenDAction = new QAction("STrenD Analysis", this->CentralWidget);
	this->STrenDAction->setShortcut(Qt::CTRL + Qt::ALT + Qt::Key_S);
	connect (this->STrenDAction, SIGNAL(triggered()), this, SLOT(STrenDAnalysis()));
...
void View3D::CreateLayout()
{
	...
	this->analysisViews->addAction(this->STrenDAction);
...
void View3D::STrenDAnalysis()
{
	...
	else
	{
		...
		spdkNNGWin->setModels( featureTable, this->CellModel->GetObjectSelection());
		spdkNNGWin->show();
	}
}
